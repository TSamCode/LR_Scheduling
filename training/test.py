...
from scheduler import congestion_avoid

def test_congestion_avoider(start_time, testloader, device, model, optimizer, scheduler, branch_one_grads, branch_two_grads, branch_one_class, branch_two_class, branch_one_criterion, branch_two_criterion, condition):
    model.eval()
    ...
    with torch.no_grad():
        ...
        optimizer, model = congestion_avoid(model, optimizer, branch_one_val_acc, branch_two_val_acc, condition, branch_one_grads, branch_two_grads)
        scheduler.step()
    ...
    return optimizer, branch_one_val_acc, branch_two_val_acc