...
def test_TCP_branches(start_time, device, testloader, model, branch_one_criterion, branch_two_criterion, branch_one_class, branch_two_class):
    model.eval()
    branch_one_test_loss = 0
    branch_two_test_loss = 0
    branch_one_correct = 0
    ...
    branch_two_acc = branch_two_correct / branch_two_total

    return branch_one_acc, branch_two_acc